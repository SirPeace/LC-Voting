<div x-cloak
  ...
  <div class="flex items-end justify-center min-h-screen">
    ...
    <div
         ...
         class="modal bg-white rounded-tl-xl rounded-tr-xl overflow-hidden transform transition-all py-4 sm:max-w-xl sm:w-full">
      ...
      <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
        ...
        <p class="text-xs text-center leading-5 text-gray-500 px-6 mt-4">You have <strong>one hour</strong> to edit your
          idea from the time you created it.</p>
        ...
        <form
          ...
          <div>
            <input wire:model.defer="title" type="text"
                   class="w-full text-sm bg-gray-100 border-none rounded-xl placeholder-gray-900 px-4 py-2 transition duration-150 ease-in"
